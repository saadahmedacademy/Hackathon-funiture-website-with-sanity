...
const page = () => {
  ...
  return (
    <main className='py-10 bg-gradient-to-br from-gray-50 to-gray-100 
       ...
       w-full text-center'>
        ...
        <div className="space-y-4 text-gray-700">
          <p>
            ...
            A corfirmation email will received you soon.
          </p>
        ...
        <div className="bg-gray-50 rounded-lg border-gray-200 p-4 mt-6 sapace-y-2">
